...
Ng_core = 86e6/4;
Ach_mm2_core = 18.5/16;
gate_pitch_core = 465e-9*2/4;
%min_pitch_core = 112.5e-9/4;
min_pitch_core = 5e-9;
fmax_core = 3.5e9;
w_trans = 32e-9/4;
Vdd_core = 1.25;
...
Ng_gpu = 2.05e8/4;
Ach_mm2_gpu = 44.5;
gate_pitch_gpu = gate_pitch_core; % average gate pitch (sqrt(A_core/Ngates))
%min_pitch_gpu = 112.5e-9; % actual contacted gate pitch
min_pitch_gpu = min_pitch_core;
fmax_gpu = 1.35e9;
Vdd_gpu = 1.25;
