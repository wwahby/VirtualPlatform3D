...
design.Ng_core = 1639050; %86M transistors, assume 2in NAND -> /4 to get total NAND gates
design.Ach_mm2 = 5.198;
...
design.rent_exp = 0.58;%rent_exp_logic;
...
scaling_factors = 1; %32/28; %[32/22 32/14 32/10 32/7 32/5];
