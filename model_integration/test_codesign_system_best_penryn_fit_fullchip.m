...
Ng = 48e6/4;
Ach_mm2 = 21.6;
gate_pitch = 2*667e-9; % average gate pitch (sqrt(A_core/Ngates))
min_pitch = 160e-9; % actual contacted gate pitch
fmax = 3.33e9;
w_trans = 45e-9;
...
wire.routing_efficiency = [ 0.1 0.5 ];  % (-) Fraction of available area that the wire routing tool can actually use
wire.repeater_fraction = fliplr([ 0.5 ]); % (-) fraction of optimal repeaters to insert
