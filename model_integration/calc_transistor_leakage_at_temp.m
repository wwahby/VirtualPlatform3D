function [Plk_tot, Plk_per_transistor_per_um, Ilk_T] = calc_transistor_leakage_at_temp(temperature_C, leakage_reference_temperature_K, Vdd, Vth, Ioff_per_um, w_trans_min_m, transistor_widths_um, transistor_numbers)
