function [width, pitch, delay, R, C, C_pul, rho, R_cu, R_barrier] = find_best_cu_wire(delay_max, width_guess, min_pitch, resistivity_bulk, barrier_thickness, resistivity_barrier, wire_length, width_fraction, aspect_ratio, electron_mfp, specularity_coeff, reflection_coeff, epsr_dielectric, temperature_K)
