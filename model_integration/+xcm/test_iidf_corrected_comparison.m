...
% Tsv parameters
Atf_max = 0.010; % maximum allowable TSV area, as a fraction of total chip area
gate_pitch = 100e-9;
h_tsv_m = 300e-6;
AR_tsv = 20;
...
%% Calculate WLD
iidf_c = xcm.calc_Iidf_corrected(alpha,k,p,Lxc,S,h_tsv,Nuc_1d,w_tsv);
iidf_j = xcm.calc_Iidf(alpha,k,p,Lx,S,h_tsv);

%AA = calc_Nstart(Lx,S,r);
Mt3dj = xcm.Mt_3d_joyner(Lx,S,r);
