...
[lmax_2d l2d Ns] = xcm.get_params_2d(Lx);

[lmax3d l3d Ns Ng] = xcm.get_params_3d(Lx,S,r);

% Get 2D distribution
%Mt2d = Mt_2d_joyner(Lx);
Mt2d = xcm.Mt2d_corrected(Lx, Nuc_1d, w_tsv);

Mt3d = zeros(1,length(l3d));
% v=0 case
Mt3d(1:length(l2d)) = (1-xcm.dd(l2d)).*S.*Mt2d;

% The rest of the cases
Sind_max = S-1;
for v=1:Sind_max
    MM = [zeros(1,v*r) Mt2d zeros(1,(Sind_max-v)*r) ];
    Mt3d= Mt3d + (2-xcm.dd(l3d-v*r)) .* (S-v) .* MM;
end