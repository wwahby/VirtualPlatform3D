...
wire.routing_efficiency = [ 0.6 ];  % (-) Fraction of available area that the wire routing tool can actually use
wire.repeater_fraction = [ 0.3 0.5 1]; % (-) fraction of optimal repeaters to insert. If topdown WLARI is used, these are ordered from top wiring level to bottom wiring level, otherwise they are from bottom to top.
