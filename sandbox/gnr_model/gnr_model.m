...
M = 10; % number of segments to break XC into
N = 3; % number of layers of graphene in GNR

L = 1e-6; % (m) length of GNR XC
W = 100e-9; % (m) width of GNR XC
...
lambda_d = 100e-9; % (m) MFP from defect scattering in graphene on SiO2
P = 0.2; % (-) Backscattering probability
