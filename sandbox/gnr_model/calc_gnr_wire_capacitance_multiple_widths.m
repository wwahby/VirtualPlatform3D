function [C_gnr C_gnr_raw cap_const Cqe Calpha] = calc_gnr_wire_capacitance_multiple_widths(num_layers,widths,Nch_vec,gnr_length,thickness,height_dielectric,epsrd)
...
Cqe = 4*q^2/h0/vf * num_layers * Nch_vec; % (F/m) Quantum capacitance;
