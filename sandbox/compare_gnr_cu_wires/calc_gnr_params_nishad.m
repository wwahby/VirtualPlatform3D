function [delay_top delay_side R_top R_side L C] = calc_gnr_params_nishad(num_layers,gnr_width,gnr_length,Temp_K,mfp_defect,rho_interlayer,prob_backscattering,Ef,contact_resistance,epsrd,height_dielectric)
