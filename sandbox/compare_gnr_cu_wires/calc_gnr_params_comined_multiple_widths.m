function [delay_top delay_side R_top R_side L C] = calc_gnr_params_combined(num_layers,gnr_width,gnr_length,Temp_K,mfp_defect,rho_interlayer,prob_backscattering,Ef,contact_resistance,epsrd,height_dielectric)
...
[ Nch, Rsheet, leff] = sheetres_single_mGNR_ld1u_mod( Ef,gnr_width_nm,prob_backscattering,Temp_K,mfp_defect_nm);   
...
[Rnet Reff] = calc_gnr_resistance_kumar(num_layers,gnr_width,gnr_length,Temp_K,mfp_defect,rho_interlayer,prob_backscattering,Ef,contact_resistance);
