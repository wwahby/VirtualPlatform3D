function [Rnet Reff] = calc_gnr_params(num_layers,gnr_width,gnr_length,temp,defect_mfp,rho_interlayer,prob_backscattering,Ef,contact_resistance)
...
W_nm = W*1e9;
[ Nch,Rsheet,leff] = sheetres_single_mGNR_ld1u_mod( Ef,W_nm,P,T,lambda_d*1e9);
