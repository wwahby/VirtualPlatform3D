...
%     c_pul = (Cq^-1 + Ce^-1)^-1;
    ...
    [C_gnr C_gnr_raw cap_const Cqe Calpha] = calc_gnr_wire_capacitance(num_layers,Ef,Temp_K,gnr_width,gnr_length,thickness,height_dielectric,epsrd,prob_backscattering,mfp_defect);
